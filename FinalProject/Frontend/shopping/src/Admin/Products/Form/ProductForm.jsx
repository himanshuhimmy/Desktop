...
const ProductForm = () => {
  const { activeProductId, ProductType } = useContext(AdminContext);
  const { allThemes, allCategorys, setRefresh } = useContext(AppContext);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      alert("Product synced with database!");
