...
// app.get("/userWishlist/:id", async (req, resp) => {
//   let data = await wishlistModel.find({ userId: req.params.id });
//   resp.send(data);
// });

// app.post("/add/Product/Wishlist", async (req, resp) => {
//   let result = await wishlistModel(req.body);
//   let data = result.save();
//   resp.send(data);
// });

// app.delete("/remove/product/wishlist", async (req, resp) => {});
